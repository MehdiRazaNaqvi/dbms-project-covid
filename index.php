...
<div class="wrapper col1">
  <div id="container">
    <div id="content">
      <h1>Welcome to Online Covid Management System</h1>
      ...
      <div class="homecontent">
        <ul>
          <li>
            ...
            <p class="imgholder"><a href="patientappointment.php"><img src="images/appoint4.png" alt="" style="width:286px;height:100px;" /></a></p>
          </li>
          <li class="last">
            <h2>Login Panel for existing users</h2>          
            <p class="imgholder"><a href="patientlogin.php"><img src="images/lgn.png" alt="" style="width:286px;height:100px;"  /></a></p>
          </li>
        </ul>
        <div class="clear"></div>
      </div>
